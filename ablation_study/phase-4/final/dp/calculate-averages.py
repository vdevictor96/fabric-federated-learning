...
input_file_path = '/local/vpaloma/fabric-federated-learning/ablation_study/phase-4/final/dp/model_accuracy_summary.txt'
output_file_path = '/local/vpaloma/fabric-federated-learning/ablation_study/phase-4/final/dp/model_accuracy_averaged_summary.txt'
