...
input_file_path = '/local/vpaloma/fabric-federated-learning/ablation_study/phase-2/4-execution_time/model_execution_time_summary.txt'
output_file_path = '/local/vpaloma/fabric-federated-learning/ablation_study/phase-2/4-execution_time/model_execution_time_averaged_summary.txt'
